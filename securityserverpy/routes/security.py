...
class Security(object):
    ...
    @app.route('{0}/get_config'.format(_ROOT_PATH), methods=['POST'])
    def get_config(self):
        """get security config
        ...
        status, error = verify(request.json, keys=required_data_keys, all_should_exist=False)
    ...
    @app.route('{0}/add_config'.format(_ROOT_PATH), methods=['POST'])
    def add_config(self):
        """add security config
    ...
    @app.route('{0}/arm'.format(_ROOT_PATH), methods=['POST'])
    def arm(self):
        """arm system
    ...
    @app.route('{0}/disarm'.format(_ROOT_PATH), methods=['POST'])
    def disarm(self):
        """disarm system
    ...
    @app.route('{0}/false_alarm'.format(_ROOT_PATH), methods=['POST'])
    ...
    @app.route('{0}/panic'.format(_ROOT_PATH), methods=['POST'])
    def panic(self):
    ...
    @app.route('{0}/set_breach'.format(_ROOT_PATH), methods=['POST'])
    def set_breach(self):
    ...
    @app.route('{0}/get_logs'.format(_ROOT_PATH), methods=['POST'])
    def get_logs(self):
        """get logs for user
